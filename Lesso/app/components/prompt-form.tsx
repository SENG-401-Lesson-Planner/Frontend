            ...
            >
                ...
                {!submitted ? (
                    <form onSubmit={handleSubmit}>
                        <label htmlFor="lesson-plan" className="block text-sm font-medium text-white mb-2">
                        ...
                        <div className="flex justify-center">
                            <button type="submit" className="px-4 py-2 bg-white text-[#44264E] rounded-md hover:bg-[#44264E] hover:text-white">
                                Get Lesson Plan
                            </button>
                        </div>
                    </form>
