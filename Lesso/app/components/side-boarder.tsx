...
const SideBoarder: React.FC = () => {
    ...
    return (
        <div className="fixed left-0 top-0 h-full w-full sm:w-1/3 flex flex-col items-center p-4 sm:p-6 shadow-xl text-white" style={{ backgroundColor: 'rgba(0, 0, 0, 0.5)' }}>
            ...
            <p className="mt-2 text-sm sm:text-base md:text-lg lg:text-3xl text-center">Smarter & Faster Scheduling with AI-Powered Prompts.</p>
            <button onClick={handleGetStarted} className="mt-6 sm:mt-10 px-4 py-2 sm:px-6 sm:py-3 bg-white text-[#44264E] font-semibold rounded-lg shadow-md hover:bg-gray-200">Get Started</button>
            <style>{`
